...
wizard %>% 
  mutate(text = str_replace_all(text, "tin man", "tin_man"))  %>% 
  mutate(text = str_replace_all(text, "Tin Woodman", "tin_man")) -> wizard
```
...
wizard_counts %>%
  bind_tf_idf(word, chapter, n) -> wizard_tf_idf
wizard_tf_idf
```
...
ggsave("doc/wizard-tirsdag.pdf", width = 65, height = 35, units = "cm")
```
