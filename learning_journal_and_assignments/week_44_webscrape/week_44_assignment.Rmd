...
So by navigating to the "blockqoute" element, I can grab the "child" (which is "p") and then navigate to the relevant "a" element and then select all a elements that contain a link (a href attribute). This ensures, that I won't get "a" elements without links.
...
data("stop_words")#Get all stopwords
 ...
 `debate_october-11-1984` %>% #Chose the debate of october 11 th. 1984.
  ...
  geom_col() + #Make it a bar chart where the hight represents the value
