...
Tidytext lader os bryde teksten. Hvert ord kommer herefter i en række. Herefter kan de tælles og summariseres og summarieses.
Hvis man analyserer følelser analyserer man dem ud fra hvert ord. 
Herefter fjerner man stop ord og fjerner karakterer. 
Det essentielle er at fjerne stopord. Hvis man vil se de mest usædvanline ord, vil man fjerne stopord. 
Den basic stopwordstekst er i pakken. Man kan herefter tilføje ord. 
Sentiment analyse: Man identificerer følelser og subjektive følelser. Hvilke følelser har de? 
Det kan gøres vha. 
-Binary: Positiv og negativ
-Ordinal: En rangering fra -5 til +5, hvor positivt og negativt er det?
-Word-emotion association: Nogle ord er klassificeret. 

Der er ofte forskel på hvordan man associeerere ord alt efter kulturen.
Hvis man ikke benytter engelsk, så støder man ofte på problemer. 

Afinn leksikon
Sentida (dansk)
Det bruges ikke kun fra litterære forskere, det kan også bruges til forretningscases. Hvordan påvirker offentlige meninger en virksomhed? 

"here" pakken bruges, så vi ikke behøves at skrive hele stien. Dette fremmer reproducerbarheden. 
